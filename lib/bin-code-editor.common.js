...
var _stringify = _interopRequireDefault(__webpack_require__(172));
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    if (this.autoFormat && this.value && this.value.length > 0) {
      try {
        var formatStr = (0, _stringify.default)(JSON.parse(this.value), null, 2);
...
/* harmony import */ var _code_editor_vue_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(183);
